...
export default function ProfileHeader({ pageData, favrioutes }) {
  ...
  const handleBookmark = (id, value) => {
    ...
    let isSuccess = value ? removeFavrioute(id) : addFavrioute(id);
                ...
                >
                  <div className="rbt-tutor-information-left" style={{ textAlign: isMobile ? "center" : "left" }}>
                    ...
                    <div className="tutor-content">
                      <h1 style={{ fontSize: isMobile ? "20px" : "28px", margin: 4 }}>
                        {pageData.user.name}
                      </h1>
                      <h2 style={{ fontSize: isMobile ? "16px" : "22px", fontWeight: 500, wordBreak: "break-word" }}>
